...
import com.yurets.domain.interactor.GetFavoriteJokesUseCase
...
@Inject constructor (private val getFavoriteJokesUseCase: GetFavoriteJokesUseCase,
    ...
    private fun getJokeList(page: Int) {
        getFavoriteJokesUseCase.getFavoriteJokes(page)
